...
import 'dart:async';
import 'package:gudang_apotek/dbhelper.dart';
import 'package:gudang_apotek/pages/entryform.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(        
        ...
        title: Text('PT Dya Farma', style: TextStyle(fontWeight: FontWeight.bold),),
      ),
      body: 
              Column(
                children: [
                  Container(
                    alignment: Alignment.topLeft, color: Colors.orangeAccent,
                    margin: EdgeInsets.only(top: 3, bottom: 10, left: 0, right: 100),
                    child:
                        Row(
                  ...
                  Column(
                    ...
                    children: [
                      Text("Galeri Dya Farma >",style: TextStyle(color: Colors.deepOrangeAccent[400]),),
                      Container(
