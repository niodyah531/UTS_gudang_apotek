              ...
              children: <Widget>[
                Container(
                  ...
                  child: Column(
                    children: [
                      Row(
                        children: [ Icon(Icons.local_pharmacy, size: 80, color: Colors.deepOrange[400],),
                          Padding(
                            padding: EdgeInsets.only(top: 20.0, bottom: 20.0),
                            child: Text("PT. Dya Farma", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color: Colors.deepOrangeAccent[200]),),
                          ),
                        ],
                      ),
                    ],
                ...
                Column(
                  ...
                  children: [
                    Text("Galeri Dya Farma >", style: TextStyle(color: Colors.deepOrangeAccent),),
                    Container(
